...
const token_service_1 = __webpack_require__(18);
const pool_service_1 = __webpack_require__(19);
const pool_discovery_service_1 = __webpack_require__(20);
const quote_service_1 = __webpack_require__(12);
const orderbook_service_1 = __webpack_require__(11);
const swap_service_1 = __webpack_require__(21);
const indexer_service_1 = __webpack_require__(22);
const risk_service_1 = __webpack_require__(17);
const candle_service_1 = __webpack_require__(16);
const events_gateway_1 = __webpack_require__(23);
const ens_controller_1 = __webpack_require__(26);
const oracle_feed_service_1 = __webpack_require__(28);
const oracle_service_1 = __webpack_require__(15);
const oracle_controller_1 = __webpack_require__(30);
const swap_controller_1 = __webpack_require__(31);
const gas_station_service_1 = __webpack_require__(32);
const gas_station_controller_1 = __webpack_require__(33);
const mt5_controller_1 = __webpack_require__(34);
...
let MarketService = MarketService_1 = class MarketService {
    ...
    async createMarket(params) {
        ...
        const quoteToken = (params.quoteToken || "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2").toLowerCase(); // WETH default
        // Normalize addresses
        ...
        // Run risk check (inject RiskService or inline check)
        // For now, trust the token — let RiskService handle validation
        const baseSymbol = tokenAddress.slice(0, 6);
        const quoteSymbol = "WETH";
        // Generate market ID
        const marketId = baseSymbol + "-" + quoteSymbol + "-UNI3-" + (chainId === 1 ? "ETH" : chainId === 8453 ? "BASE" : "CHAIN" + chainId);
        // Register token
        await this.prisma.token.upsert({
            where: { chainId_address: { chainId, address: base } },
            update: {},
            create: { chainId, address: base, symbol: baseSymbol },
        });
        // Create market (pool address would need to be discovered)
        ...
        return { created: true, marketId: market.marketId };
    }
    async getEthUsd() {
        const now = Date.now();
...
const abis_1 = __webpack_require__(14);
...
let RiskService = RiskService_1 = class RiskService {
    ...
    async assessToken(chainId, tokenAddress) {
        ...
        await this.prisma.token.upsert({
            ...
            update: { riskScore: score, riskLevel: level },
            create: { chainId, address: tokenAddress, riskScore: score, riskLevel: level },
...
const viem_1 = __webpack_require__(9);
const chains_1 = __webpack_require__(10);
const accounts_1 = __webpack_require__(29);
const market_service_1 = __webpack_require__(8);
const prisma_service_1 = __webpack_require__(5);
